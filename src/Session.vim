...
set cmdheight=3
set confirm
set errorformat=%-Z\ %#,%W%f:%l:%c:\ Warning:\ %m,%E%f:%l:%c:\ %m,%E%>%f:%l:%c:,%+C\ \ %#%m,%W%>%f:%l:%c:,%+C\ \ %#%tarning:\ %m,
...
silent! normal! zE
let s:l = 233 - ((14 * winheight(0) + 25) / 50)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 149 - ((16 * winheight(0) + 25) / 50)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
149
